...
const Threadidreplies=()=>{
    ...
    <div className='thread-searchpage'>
            ...
            <div className='thread-profile-different-buttons'>
                <div className='profile-thread-button-2'>
                    <button onClick={()=>navigate("/threadfriendid")}>Threads</button>
                </div>
                <div className='profile-replies-button-2'>
                    <button>Replies</button>
                </div>
                <div className='profile-repost-button-2'>
                    <button onClick={()=>navigate("/threadidrepost")}>Reposts</button>
                </div>
            </div>

            <div className='profile-button-line'>
            <div className='thread-button-line-2'></div>
            </div>

            <div className='profile-no-replies'>
                <p>No replies yet.</p>
            </div>
...
export default Threadidreplies;