    ...
    return (
        <>
            ...
            <ul>
                ...
                <li className='item1search'><button ><img src={threadheart}></img></button></li>
            ...
            <div className='thread-notification-different-buttons'>
                ...
                <button onClick={()=>navigate("/threadmention")}>Mentions</button>
                </div>
            ...
            <div className='thread-check-follower'>
                <div className='thread-follower-id'>
                     <div className='thread-follower-pic'>
                          <img src={hero4}></img>
                     </div>
                     <div className='thread-follower-username'>
                        <span><p>yogesh01</p></span>
                        <h1>Followed you</h1>
                     </div>
                     <div className='follow-back-button'>
